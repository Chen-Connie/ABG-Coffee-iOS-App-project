//
//  SelfOrderCartUIView.swift
//  ABG coffee
//
//  Created by  Belum on 2021/8/8.
//
...
struct SelfPage1OrderCartUIView: View {
                                ...
                                HStack {
                                    ...
                                    .alert(isPresented: $showAlert, content: {
                                        Alert(title: Text("確認取消訂購餐點/訂單？"),
                                         ...
                                         NavigationLink(destination: SelfPage2OrderCartUIView()) {
...
struct SelfPage1OrderCartUIView_Previews: PreviewProvider {
    static var previews: some View {
        SelfPage1OrderCartUIView()
    }
}
