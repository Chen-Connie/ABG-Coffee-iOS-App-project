...
struct Page2OrderCartUIView: View {
                        ...
                        ScrollView {
                            ...
                            VStack {
                                ...
                                .frame(minWidth: 100, minHeight: 20 )
                                        ...
                                        NavigationLink(destination: Page3OrderCartUIView()) {
...
struct Page2OrderCartUIView_Previews: PreviewProvider {
    static var previews: some View {
        Page2OrderCartUIView()
    }
}
