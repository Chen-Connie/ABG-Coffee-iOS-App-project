//
//  SelfPage2OrderCartUIView.swift
//  ABG coffee
//
//  Created by  Belum on 2021/8/13.
//

import SwiftUI

struct SelfPage2OrderCartUIView: View {
    ...
    @State private var showingPaymentAlert = false /* 彈跳式視窗*/
    @State var count1 = 0
    @State var count2 = 0
                    ...
                    VStack {
                        ...
                        ScrollView {
                            ...
                            VStack {
                                ...
                                NavigationLink(destination: SelfPage3OrderCartUIView()) {
...
struct SelfPage2OrderCartUIView_Previews: PreviewProvider {
    static var previews: some View {
        SelfPage2OrderCartUIView()
    }
}
