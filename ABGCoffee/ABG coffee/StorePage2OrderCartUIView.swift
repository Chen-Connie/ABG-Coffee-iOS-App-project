//
//  StorePage2OrderCartUIView.swift
//  ABG coffee
//
...
struct StorePage2OrderCartUIView: View {
    @State var count1 = 0
    @State var count2 = 0
                        ...
                        ScrollView {
                            ...
                            VStack{
                                ...
                                .padding(.bottom, 20)
                                 ...
                                 NavigationLink(destination: StorePage3OrderCartUIView()) {
                                  
                                  Text("完成匯款；填寫資料")
                                 .frame(minWidth: 210, minHeight: 30)
...
struct StorePage2OrderCartUIView_Previews: PreviewProvider {
    static var previews: some View {
        StorePage2OrderCartUIView()
    }
}
