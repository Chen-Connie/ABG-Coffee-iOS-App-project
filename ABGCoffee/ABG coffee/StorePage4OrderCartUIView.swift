//
//  StorePage4OrderCartUIView.swift
//  ABG coffee
//
...
struct StorePage4OrderCartUIView: View {
                            ...
                            VStack{
                                ...
                                HStack {
                                    ...
                                    .alert(isPresented: $showAlert) {
                                        Alert(title: Text("餐點製作中，恕無法提供取消服務"),
...
struct StorePage4OrderCartUIView_Previews: PreviewProvider {
    static var previews: some View {
        StorePage4OrderCartUIView()
    }
}
