//
//  StorePage3OrderCartUIView.swift
//  ABG coffee
//
//  Created by  Belum on 2021/8/24.
//

import SwiftUI

struct StorePage3OrderCartUIView: View {
    @State private var phoneNumber = " "
    @State private var address = " "
    @State private var remark = " "
    @State private var name = " "
    @State private var fiveNumber = " "
                        ...
                        ScrollView {
                            ...
                            VStack {
                                ...
                                .frame(minWidth: 100, minHeight: 20 )
                                        ...
                                        NavigationLink(destination: StorePage4OrderCartUIView()) {
                            ...
                            HStack {
                                Button(action: {self.showAlert = true
                                    ...
                                    Text("取消訂餐")
                                        ...
                                        .font(.system(size: 16, weight: .regular))
                                        .background(Color("CancelOrderLightBlueButton"))
                                        .foregroundColor(.white)
                                        .cornerRadius(6)
                                }
                                .alert(isPresented: $showAlert, content: {
                                    Alert(title: Text("確認取消訂購餐點/訂單？"),
                                          message: Text(""),
                                          primaryButton: .destructive(Text("確認")) {print("轉出中...") },
                                          secondaryButton: .cancel())
                                })
                                

                             NavigationLink(destination: StorePage2OrderCartUIView()) {
                              
                              Text("確認訂餐")
                                  .frame(maxWidth: 70, minHeight: 30)
                                  .font(.system(size: 16, weight: .regular))
                                  .background(Color("OrderButtonBlue"))
                                  .foregroundColor(.white)
                                  .cornerRadius(6)
...
struct StorePage3OrderCartUIView_Previews: PreviewProvider {
    static var previews: some View {
        StorePage3OrderCartUIView()
    }
}
